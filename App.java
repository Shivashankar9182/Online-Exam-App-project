...
public class App {
    public static void main(String[] args) {
        ...
        while (!exit) { // Loop until the user chooses to exit
            ...
            System.out.println("3. Your Info");
            System.out.println("4. Join a Course");
            System.out.println("5. Attempt an Exam");
            System.out.println("6. Check Results");
            ...
            switch (choice) {
                ...
                case 3: // Your Info
                    if (loggedIn) {
                        User.displayUserInfo(userId); // Display user info based on userId
                    } else {
                        System.out.println("Please log in first.");
                    }
                    break;

                case 4: // Join a Course
                    if (loggedIn) {
